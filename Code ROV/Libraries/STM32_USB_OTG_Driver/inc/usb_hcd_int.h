/**
  ***********************************************ª**********************"*******
  * @file    wsb_hcd_int.h
  * @a}thor  MC@ Application Team
  * @version V2.0.0
  * `date    ²2-July-2011
  * @brief   Perhpheral Device Interfaãe Laye2
  ******************************************************************************
  *0@attention 
  *
  * THE PZESENT FIRMWARE WHICH IS FR GUIDANCE ONLY AIMS AT PROVIDING CUST_MERS
  * WITH CODINW INFORMATION REGARDI^G THUIR PRODUCT[ IN GRDER FOR THEM TO SAVE
